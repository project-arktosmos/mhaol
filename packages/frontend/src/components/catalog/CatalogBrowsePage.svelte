<script lang="ts">
	...
	import BrowseHeader from '$components/browse/BrowseHeader.svelte';
	import BrowseGrid from '$components/browse/BrowseGrid.svelte';
	import Portal from '$components/core/Portal.svelte';
	...
	import type { CatalogBrowseState, CatalogItem, CatalogCardData } from '$types/catalog.type';
	import { MEDIA_BAR_KEY, type MediaBarContext } from '$types/media-bar.type';
