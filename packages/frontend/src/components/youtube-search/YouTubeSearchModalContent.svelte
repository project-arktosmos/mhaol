<script lang="ts">
	...
	import YouTubeSearchInput from 'frontend/components/youtube-search/YouTubeSearchInput.svelte';
	import YouTubeSearchResultCard from 'frontend/components/youtube-search/YouTubeSearchResultCard.svelte';
