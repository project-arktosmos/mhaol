...
├── state.rs             # CloudState: { db, identity_manager, ytdl_manager, torrent_manager, ipfs_manager, ipfs_stream_manager, track_progress, album_download_progress, ytdl_channel_cache }
