<script lang="ts">
	...
	import { musicRecommendationsService } from '$services/music-recommendations.service';
	...
	import { albumStrategy } from '$services/catalog-strategies/album.strategy';
	import { isAlbum } from '$types/catalog.type';
