<script lang="ts">
	...
	import type { YouTubeChannelMeta, SubtitleTrack } from '$types/youtube.type';
	import { fetchRaw, resolveApiUrl } from '$transport/fetch-helpers';
	import MediaPlayer from '$components/player/MediaPlayer.svelte';
